...
id_list = [1, 77]
names_list = ['Insan', 'Telefon']
im_ext = 'jpg'
COCO_images = r'C:\Users\XTI\Desktop\COCO\DATASETS\train2017'
Json_addr = r'C:\Users\XTI\Desktop\COCO\DATASETS\instances_train2017.json'
im_num = 0
ob_count = 0
im_pairs = dict()
